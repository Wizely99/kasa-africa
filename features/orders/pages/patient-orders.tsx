...
import { Search, Package, Truck, Eye, RotateCcw, FileText, Download, Calendar, MapPin, Clock } from "lucide-react"
...
const mockOrders: Order[] = [
  {
    ...
    items: [
      { id: "1", productName: "Metformin 500mg", quantity: 60, unitPrice: 25.99, totalPrice: 25.99, requiresPrescription: true },
      { id: "2", productName: "Blood Glucose Test Strips", quantity: 1, unitPrice: 45.50, totalPrice: 45.50, requiresPrescription: false }
    ],
    totalAmount: 76.49,
    status: "processing",
  ...
  },
  {
    ...
    items: [
      { id: "3", productName: "Digital Thermometer", quantity: 1, unitPrice: 29.99, totalPrice: 29.99, requiresPrescription: false }
    ],
    totalAmount: 34.99,
    status: "delivered",
    deliveryAddress: "123 Main St, Dar es Salaam, Tanzania",
  ...
  },
  {
    ...
    items: [
      { id: "4", productName: "Paracetamol 500mg", quantity: 30, unitPrice: 8.99, totalPrice: 8.99, requiresPrescription: false },
      { id: "5", productName: "Vitamin D3 Supplements", quantity: 1, unitPrice: 19.99, totalPrice: 19.99, requiresPrescription: false }
    ],
    totalAmount: 33.98,
    status: "delivered",
    deliveryAddress: "123 Main St, Dar es Salaam, Tanzania",
...
export default function MyOrdersPage() {
  ...
  const getStatusConfig = (status: string) => {
    const configs = {
      ...
      confirmed: { color: "bg-blue-50 text-blue-700 border-blue-200", icon: FileText },
      ...
      delivered: { color: "bg-emerald-50 text-emerald-700 border-emerald-200", icon: Package },
      cancelled: { color: "bg-red-50 text-red-700 border-red-200", icon: Package }
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-600">Track your pharmacy orders and download receipts</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="bg-gradient-to-br from-amber-50 to-amber-100 border-amber-200 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-medium text-amber-700">Active Orders</CardTitle>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-amber-900">{activeOrders}</div>
          ...
          <Card className="bg-gradient-to-br from-emerald-50 to-emerald-100 border-emerald-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-emerald-900">{deliveredOrders}</div>
          ...
          <CardContent>
            <div className="space-y-4">
              {recentOrders.map((order) => {
                ...
                return (
                  <div key={order.id} className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <div className="flex items-center gap-3">
                      <Badge className={`${statusConfig.color} flex items-center gap-1 px-3 py-1 border`}>
          ...
          <CardContent>
            <div className="space-y-4">
              {filteredOrders.map((order) => {
                ...
                const StatusIcon = statusConfig.icon
                return (
                  <div key={order.id} className="p-6 bg-white rounded-xl border border-gray-100 hover:shadow-md transition-all duration-200">
