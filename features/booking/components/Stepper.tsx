      ...
      {steps.map((step, idx) => {
        ...
        return (
          <li key={step.id} className="flex w-full items-center">
            <div className="flex items-center gap-3">
              <div
                ...
                className={cn(
                  ...
                  isActive && !isCompleted && "border-emerald-600 bg-emerald-50 text-emerald-700",
            ...
            {!isLast && <div className="mx-2 hidden h-[2px] flex-1 bg-muted md:block" aria-hidden="true" />}
          </li>
        )
      })}
    </ol>
