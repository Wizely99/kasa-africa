    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-4">
        <motion.div
          ...
          className="w-full max-w-2xl sm:max-w-md"
        >
          <Card className="bg-white/80 backdrop-blur-xs shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 " />
            {/* Card header */}
            <CardHeader className="relative space-y-4 pt-8 pb-8 text-center border-none">
              {/* Logo section */}
              <motion.div
              ...
              >
                <div className="relative">
                  ...
                  {/* <Image
                      ...
                      priority
                    /> */}
                  <div className="flex aspect-square size-24 sm:size-20 items-center justify-center rounded-lg bg-primary text-primary-foreground">
                    <Heart className="w-10 h-10 sm:w-8 sm:h-8" />
                  </div>
                </div>
              </motion.div>
              ...
              >
                <CardTitle className="text-4xl sm:text-2xl font-bold bg-linear-to-r from-primary via-blue-600 to-indigo-700 bg-clip-text text-transparent">
                  Welcome to Kasa Africa
                </CardTitle>
                <div className="flex items-center justify-center gap-2 text-slate-600 text-sm sm:text-xs">
                  <Sparkles className="size-4 text-primary" />
                  <CardDescription className="text-base sm:text-sm text-slate-700">
            ...
            {/* Card content */}
            <CardContent className="relative px-6 sm:px-4 py-4 space-y-4">
              {/* Sign in button */}
              <motion.div
                // initial={{ opacity: 0, y: 20 }}
                // animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <Button
                  className="relative w-full py-4 sm:py-3 text-lg sm:text-base font-semibold bg-linear-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-700 border-0 rounded-xl shadow-lg text-white transition-all duration-300"
                  onClick={() =>
              ...
              <motion.div
                ...
                className="flex items-center justify-center gap-2 text-slate-600 text-sm sm:text-xs"
              >
            ...
            {/* Card footer */}
            <CardFooter className="relative px-6 sm:px-4 pb-8 ">
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1, duration: 0.6 }}
                className="w-full space-y-4 sm:space-y-3"
              >
                {/* Divider */}
                <div className="relative">
                ...
                {/* Terms */}
                <p className="text-sm text-slate-600 text-center leading-relaxed sm:text-xs">
                ...
                <div className="hidden md:grid grid-cols-3 gap-4  pt-4">
                  {[
                    ...
                    <motion.div
                      ...
                      key={index}
                      className="text-center p-2 sm:p-1 rounded-lg bg-primary/5 border border-primary/10 text-xs sm:text-[10px]"
                    >
                      <div className="text-xl sm:text-lg mb-1">
                        {feature.icon}
                      </div>
                      <div className="text-xs sm:text-[10px] text-slate-600 font-medium">
                        {feature.text}
                      </div>
                    </motion.div>
                  ))}
