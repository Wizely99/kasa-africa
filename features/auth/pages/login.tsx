    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute inset-0 bg-primary/20 backdrop-blur-sm rounded-full animate-pulse" />
          <HashLoader color="hsl(var(--primary))" size={100} speedMultiplier={0.9} />
        </motion.div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-8">
        ...
        >
          {/* Clean card design */}
          <Card className="bg-white/80 backdrop-blur-sm border border-primary/20 shadow-2xl relative overflow-hidden">
            ...
            <CardHeader className="relative space-y-6 pt-16 pb-8 text-center">
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative w-72 h-48 bg-white/50 backdrop-blur-sm rounded-2xl p-6 border border-primary/30 shadow-lg">
                    <Image
                      src="/logo.jpg"
              ...
              <motion.div
                ...
                className="space-y-4"
              >
                <CardTitle className="text-5xl font-bold bg-gradient-to-r from-primary via-blue-600 to-indigo-700 bg-clip-text text-transparent">
            ...
            <CardContent className="relative px-12 py-8 space-y-6">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-primary to-blue-600 rounded-xl blur opacity-25 group-hover:opacity-40 transition-opacity" />
                <Button
                  className="relative w-full py-8 text-xl font-semibold bg-gradient-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-700 border-0 rounded-xl shadow-lg text-white transition-all duration-300"
              ...
              >
                ...
                <span className="text-sm">HIPAA-compliant healthcare platform</span>
              </motion.div>
            </CardContent>
                ...
                <div className="grid grid-cols-3 gap-6 pt-4">
                  {[
                    ...
                    >
                      ...
                      <div className="text-xs text-slate-600 font-medium">{feature.text}</div>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
